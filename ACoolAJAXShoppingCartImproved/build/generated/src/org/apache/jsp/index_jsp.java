...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    ");
      out.write("\n");
      out.write("    <thead><th>Name</th><th>Description</th><th>Price</th><th>Add_To_Cart</th><th>Remove_To_Cart</th></thead>\n");
      out.write("  <tbody>\n");
      out.write("  ");
      out.write(" \n");
      out.write("  ");
    ...
    for (Iterator<Item> I = new Catalog().getAllItems().iterator() ; I.hasNext() ; ) {
      ...
      out.write("</td>\n");
      out.write("        <td><button onclick=\"addToCart('");
      out.print( item.getCode() );
      out.write("')\">Add to Cart</button></td>\n");
      out.write("        <td><button onclick=\"removeToCart('");
      out.print( item.getCode() );
      out.write("')\">Remove to Cart</button></td>\n");
      out.write("    </tr>\n");
      out.write("    ");
 } 
      out.write("\n");
